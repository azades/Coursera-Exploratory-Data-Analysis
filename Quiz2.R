...
Answer 2: 
A set of 3 panels showing the relationship between weight and time for 
each diet.
...
Different plotting systems have different sets of functions for annotating plots 
in this way. Which of the following functions can be used to annotate the panels 
in a multi-panel lattice plot?
Answer 3: 
lpoints()
...
print(g)
I was expecting a scatterplot of 'votes' and 'rating' to appear. Whats the 
problem?
Answer 9: 
ggplot does not yet know what type of layer to add to the plot.

Question 10
The following code creates a scatterplot of 'votes' and 'rating' from the movies 
dataset in the ggplot2 package. After loading the ggplot2 package with the
library() function, I can run
